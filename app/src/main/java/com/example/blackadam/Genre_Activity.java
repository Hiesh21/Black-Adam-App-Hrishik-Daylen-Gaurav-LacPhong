...
public class Genre_Activity extends AppCompatActivity {
    ...
    public void toSettings(){
        final Button tosettingsbutton = (Button) findViewById(R.id.button2);
        final Intent settingsintent = new Intent(this, SettingsActivity.class);
        tosettingsbutton.setOnClickListener(new Button.OnClickListener(){
            public void onClick(View view1){
                startActivity(new Intent(Genre_Activity.this, SettingsActivity.class));
            }
        });
